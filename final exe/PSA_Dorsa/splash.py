...
class SplashScreen(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Dorsa Pellet Laboratory')
    ...
    def initUI(self):
        ...
        self.labelTitle.setText('Dorsa Pellet Laboratory Grading System')
        ...
        self.progressBar.resize(self.width() - 500 - 10, 50)
        ...
        self.labelLoading.setText('The software is loading...')
...
if __name__ == '__main__':
    ...
    app.setStyleSheet('''
        ...
        QProgressBar::chunk {
            border-radius: 10px;
            background-color: qlineargradient(spread:pad x1:0, x2:1, y1:0.511364, y2:0.523, stop:0 #1C3334, stop:1 #0C508B);
        }
    ''')

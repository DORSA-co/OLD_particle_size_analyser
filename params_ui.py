...
class Params_Ui(QtWidgets.QMainWindow):
    """this class is used to build class for algorithm params UI
    ...
    def __init__(self, ui_obj):
        ...
        super(Params_Ui, self).__init__()

        # load ui file
        uic.loadUi('params_ui.ui', self)
